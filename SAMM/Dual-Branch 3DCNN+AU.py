...
output_folder = r'C:\Users\user\Desktop\micro-expression-recognition-master\SAMM\training_frames'
negativepath = 'C:/Users/user/Desktop/micro-expression-recognition-master/SAMM/data/negative/'
positivepath = 'C:/Users/user/Desktop/micro-expression-recognition-master/SAMM/data/positive/'
surprisepath = 'C:/Users/user/Desktop/micro-expression-recognition-master/SAMM/data/surprise/'
# 指定 Excel 檔案的路徑
excel_file_path = r"C:\Users\user\Desktop\micro-expression-recognition-master\SAMM_Micro_FACS_Codes_v22.xlsx"
df = pd.read_excel(excel_file_path, sheet_name='MICRO_ONLY')
...
for train_index, test_index in logo.split(X, y, groups=subjects):
    ...
    # CNN1 = Conv3D(32, (3, 3, 3), padding='same')(CNN1)
    # CNN1 = LeakyReLU(alpha=0.2)(CNN1)
    # CNN1 = MaxPooling3D(pool_size=(3, 3, 3), padding='same')(CNN1)
    # 第二個3D CNN分支
    ...
    # CNN2 = Conv3D(32, (3, 3, 3), padding='same')(CNN2)
    # CNN2 = LeakyReLU(alpha=0.2)(CNN2)
    # CNN2 = MaxPooling3D(pool_size=(3, 3, 3), padding='same')(CNN2)
    # 連接兩個分支
