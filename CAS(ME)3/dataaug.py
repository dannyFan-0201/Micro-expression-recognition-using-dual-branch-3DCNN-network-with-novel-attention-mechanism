...
# 输入影片所在的文件夹
input_folder = r'C:\Users\user\Desktop\micro-expression-recognition-master\CAS(ME)3\data\negative'
# 输出影片所在的文件夹
output_folder = r'C:\Users\user\Desktop\micro-expression-recognition-master\CAS(ME)3\data\aug'
